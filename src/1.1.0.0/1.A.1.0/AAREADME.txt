...
PDS4_SP_1A10_1100.xml
  ...
  These three files are part of the output producted by running the 9.0.0-dev
  _development) version of LDDTool (built incorporating the 1.10.1.0 point-build
  version IM) on the "SpectraLDD-1A10_1100.xml" input file, using the command line:
  
    % lddtool -lps SpectraLDD-1A10_1100.xml
  
SP-Test1-VALID.xml
SP-Test2-VALID.xml

  Two test labels that reference the 1.10.1.0 version of the IM and the 
