...
Updated 2019-03-29, ACR.
  ...
  NOTE: The 1.12.0.0 version of the Spectral Dictionary is identical to the
...
the version number "1.12.0.0" is indicated in file names as "1C00".
...
PDS4_SP_1C00_1100.xml
  ...
  These three files are part of the output producted by running the 9.1.0-dev
  (development) version of LDDTool (built incorporating the 1.12.0.0 version IM) on
  the "SpectraLDD-1C00_1100.xml" input file, using the command line:
  
    % lddtool -lps SpectraLDD-1C00_1100.xml
  
SP-Test1-VALID.xml
SP-Test2-VALID.xml

  Two test labels that reference the 1.12.0.0 version of the IM and the 
