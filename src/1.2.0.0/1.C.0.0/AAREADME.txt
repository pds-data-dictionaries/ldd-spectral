...
===========================
Updated 2019-07-29, ACR, for SP namespace version 1.2.0.0
...
PDS4_SP_1C00_1200.xml
  ...
  the "SpectraLDD-1C00_1100.xml" input file, using the command line:
    ...
    % lddtool -lps SpectraLDD-1C00_1200.xml
  
SP-Test1-VALID.xml
SP-Test2-VALID.xml

  Two test labels that reference the 1.12.0.0 version of the IM and the 
  Spectral Dictionary version 1.2.0.0.  These labels should show no 
  validation errors.
