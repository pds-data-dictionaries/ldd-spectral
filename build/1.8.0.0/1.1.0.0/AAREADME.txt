...
PDS4_SP_1800_1100.sch
PDS4_SP_1800_1100.xsd
PDS4_SP_1800_1100.xml

  These three files are part of the output producted by running the 7.1.0
  version of LDDTool (built incorporating the 1.8.0.0 IM version IM) on
  the "SpectraLDD-1800_1100.xml" input file, using the command line:
  
    % lddtool -lps SpectraLDD-1800_1100.xml
  
SP-Test1-VALID.xml
SP-Test2-VALID.xml

  Two test labels that reference the 1.8.0.0 version of the IM and the 
