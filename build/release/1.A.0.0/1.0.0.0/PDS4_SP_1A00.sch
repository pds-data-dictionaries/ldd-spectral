<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:sp  Version:1.10.0.0 - Fri May 25 18:49:00 EDT 2018 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="sp:Bin_Center_Lookup/sp:bin_center_field_name">
      ...
      <sch:assert test="if ($objtype = ('Table_Character')) then (//parent::node()[pds:local_identifier=$objid]/pds:Record_Character/pds:Field_Character/pds:name=$cntfield) else true()">
        The sp:bin_center_field_name attribute must correspond to the name of a Field_Character in the referenced Table_Character object.</sch:assert>
      <sch:assert test="if ($objtype = ('Table_Binary')) then (//parent::node()[pds:local_identifier=$objid]/pds:Record_Binary/pds:Field_Binary/pds:name=$cntfield) else true()">
        The sp:bin_center_field_name attribute must correspond to the name of a Field_Binary in the referenced Table_Binary object.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="sp:Spectral_Lookup">
      <sch:assert test="if (sp:Bin_Center_Lookup/sp:bin_center_field_name and sp:Bin_Width_Lookup/sp:bin_width_field_name) then (string(sp:Bin_Center_Lookup/sp:bin_center_field_name) != string(sp:Bin_Width_Lookup/sp:bin_width_field_name)) else true()">
  ...
  <sch:pattern>
    <sch:rule context="sp:Bin_Width_Lookup/sp:bin_width_field_name">
      ...
      <sch:let name="objid" value="string(ancestor::sp:Spectral_Characteristics/pds:Local_Internal_Reference/pds:local_identifier_reference)"/>
      <sch:let name="objtype" value="local-name(//parent::node()[pds:local_identifier=$objid])"/>
      <sch:assert test="if ($objtype = ('Table_Character')) then (//parent::node()[pds:local_identifier=$objid]/pds:Record_Character/pds:Field_Character/pds:name=$widfield) else true()">
        The sp:bin_width_field_name attribute must correspond to the name of a Field_Character in the referenced Table_Character object.</sch:assert>
      <sch:assert test="if ($objtype = ('Table_Binary')) then (//parent::node()[pds:local_identifier=$objid]/pds:Record_Binary/pds:Field_Binary/pds:name=$widfield) else true()">
        The sp:bin_width_field_name attribute must correspond to the name of a Field_Binary in the referenced Table_Binary object.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="sp:Spectral_Characteristics/sp:spectrum_format">
      ...
      <sch:assert test="if (string(node()) = '1D') then (parent::node()/sp:value_field_name) else not(parent::node()/sp:value_field_name)">
        sp:value_field_name is required when sp:spectrum_format is '1D', and prohibited otherwise.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="sp:Spectral_Characteristics/sp:spectrum_format">
      <sch:assert test=". = ('1D', '2D', '3D')">
        The attribute sp:spectrum_format must be equal to one of the following values '1D', '2D', '3D'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="sp:Uniformly_Sampled_Frequency">
      ...
      <sch:assert test="sp:first_center_frequency lt sp:last_center_frequency">
  ...
  <sch:pattern>
    <sch:rule context="sp:Uniformly_Sampled_Wavelength">
      ...
      <sch:assert test="if (sp:sampling_scale ne 'Linear') then (sp:sampling_base) else true()">
        The sp:sampling_base attribute is required for non-Linear sampling scales.</sch:assert>
      <sch:assert test="sp:first_center_wavelength lt sp:last_center_wavelength">
        In the Uniformly_Sampled classes, the first_center value must be less than the last_center value.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="sp:Uniformly_Sampled_Wavenumber">
      ...
      <sch:assert test="if (sp:sampling_scale ne 'Linear') then (sp:sampling_base) else true()">
        The sp:sampling_base attribute is required for non-Linear sampling scales.</sch:assert>
      <sch:assert test="sp:first_center_wavenumber lt sp:last_center_wavenumber">
        In the Uniformly_Sampled classes, the first_center value must be less than the last_center value.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="sp:Spectral_Characteristics/sp:value_field_name">
      ...
      <sch:let name="objid" value="string(ancestor::sp:Spectral_Characteristics/pds:Local_Internal_Reference/pds:local_identifier_reference)"/>
      <sch:let name="objtype" value="local-name(//parent::node()[pds:local_identifier=$objid])"/>
      <sch:assert test="if ($objtype = ('Table_Character')) then (//parent::node()[pds:local_identifier=$objid]/pds:Record_Character/pds:Field_Character/pds:name=$valfield) else true()">
        The sp:value_field_name attribute must correspond to the name of a Field_Character in the referenced Table_Character object.</sch:assert>
      <sch:assert test="if ($objtype = ('Table_Binary')) then (//parent::node()[pds:local_identifier=$objid]/pds:Record_Binary/pds:Field_Binary/pds:name=$valfield) else true()">
        The sp:value_field_name attribute must correspond to the name of a Field_Binary in the referenced Table_Binary object.</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
