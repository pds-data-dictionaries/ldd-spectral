<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:sp  Version:1.3.3.0 - Sat Nov 15 16:36:38 UTC 2025 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="sp:Spectral_Characteristics/pds:Local_Internal_Reference">
      ...
      <sch:let name="objtype" value="local-name(//parent::node()[pds:local_identifier=$objid])"/>
      <sch:assert test="if (pds:local_reference_type = ('spectral_characteristics_to_array_object')) then ($objtype = ('Array_1D_Spectrum', 'Array_2D_Spectrum', 'Array_3D_Spectrum')) else true()">
        <title>sp:Spectral_Characteristics/pds:Local_Internal_Reference/Rule</title>
        The Array-type object referenced by sp:Spectral_Characteristics must be either an Array_1D_Spectrum, Array_2D_Spectrum, or an Array_3D_Spectrum.</sch:assert>
  ...
  <sch:pattern>
    <sch:rule context="sp:Spectral_Characteristics/sp:spectrum_format">
      ...
      <sch:assert test="if (string(node()) = '1D') then ($objtype = ('Array_1D_Spectrum','Table_Character','Table_Binary','Table_Delimited')) else true()">
        <title>sp:Spectral_Characteristics/sp:spectrum_format/Rule</title>
        sp:spectrum_format of '1D' must be used with an Array_1D_Spectrum-type object or a table-type object.</sch:assert>
      ...
      <sch:assert test="if ((string(node()) = ('Tabulated-Parameter Groups', 'Tabulated-Point Group')) or ((string(node()) = ('1D'))) and not($objtype = ('Array_1D_Spectrum'))) then (parent::node()/sp:value_field_name) else not(parent::node()/sp:value_field_name)">
        <title>sp:Spectral_Characteristics/sp:spectrum_format/Rule</title>
        sp:value_field_name is required when sp:spectrum_format is 'Tabulated-Parameter Groups', 'Tabulated-Point Group', or '1D' with an associated table object, and prohibited otherwise.</sch:assert>
